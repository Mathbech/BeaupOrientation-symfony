 ...
 */
final class Version20241004074059 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE schools_user (schools_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_7E22D505A000581D (schools_id), INDEX IDX_7E22D505A76ED395 (user_id), PRIMARY KEY(schools_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE schools_user ADD CONSTRAINT FK_7E22D505A000581D FOREIGN KEY (schools_id) REFERENCES schools (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE schools_user ADD CONSTRAINT FK_7E22D505A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE schools_user DROP FOREIGN KEY FK_7E22D505A000581D');
        $this->addSql('ALTER TABLE schools_user DROP FOREIGN KEY FK_7E22D505A76ED395');
        $this->addSql('DROP TABLE courses');
        $this->addSql('DROP TABLE markers');
        $this->addSql('DROP TABLE schools');
        $this->addSql('DROP TABLE schools_user');
